                        ...
                        <form action="{{ route('product.store') }}" method="post">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="manifest_no" name="manifest_no" placeholder="silahkan input Manifest No" required>
                                </div>
                                <div class="mb-3">
                                    <label for="Part_name" class="form-label">Job No Customer</label>
                                    <input type="text" class="form-control" id="job_no_customer" name="job_no_customer" placeholder="silahkan input Job No Customer" required>
                                </div>
                                <div class="mb-3">
